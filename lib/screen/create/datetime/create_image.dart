                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                ...
                                await docRef.set({
                                  ...
                                  'users_image': {},
                                  "start_date": BigInfoProvider.start_date,
                                  "end_date": BigInfoProvider.end_date,
                                  "start_time": BigInfoProvider.start_time,
                                  "end_time": BigInfoProvider.end_time,
                                });
                                ...
                                BigInfoProvider.title =
                                    snapshotData[titleFieldName];
                                BigInfoProvider.code =
                                    snapshotData[codeFieldName];
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => Room(
                                      id: docRef.id,
                                      roomtitle:
                                          BigInfoProvider.title as String,
                                      roomimage:
                                          BigInfoProvider.roomImage as String,
                                      roommission:
                                          BigInfoProvider.mission as String,
                                    ),
                                  ),
                                );
                              },
